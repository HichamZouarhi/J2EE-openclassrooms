    ...
    <body>
        ...
        <div id="corps">
            ...
            <c:if test="${ !erreur }">
                ...
                <p>Numéro de téléphone : <c:out value="${ commande.client.num_tel }"/></p>
                <p>Email : <c:out value="${ commande.client.adresse_email }"/></p>
                <p>Commande</p>
                <p>Date  : <c:out value="${ commande.date }"/></p> 
                <p>Montant  : <c:out value="${ commande.montant }"/></p> 
                <p>Mode de paiement  : <c:out value="${ commande.mode_paiement }"/></p> 
                <p>Statut du paiement  : <c:out value="${ commande.status_paiement }"/></p> 
                <p>Mode de livraison  : <c:out value="${ commande.mode_livraison }"/></p> 
                <p>Statut de la livraison  : <c:out value="${ commande.status_livraison }"/></p> 
            </c:if>
        </div>
    </body>
</html>